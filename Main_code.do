...
global dofiles         = "$replication/dofiles"
...
**WDI_Cleaned_All.dta missing source file, suspect it comes from referee report
...
*(second panel of Table 1 in the draft is not updated)
